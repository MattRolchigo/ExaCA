...
struct Interface {
    ...
    view_type_int send_size_south, send_size_north, steering_vector;
    view_type_int_host send_size_south_host, send_size_north_host;
    // Initial size of new octahedra
    float _init_oct_size;
    // Size of steering veector (on a given MPI rank)
    int steering_vector_size;
    ...
    // Use default initialization to 0 for buffer counts
