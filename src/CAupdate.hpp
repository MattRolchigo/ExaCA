...
void JumpTimeStep(int &cycle, int RemainingCellsOfInterest, ViewI CritTimeStep, int LocalIncompleteCells,
                  int LocalActiveDomainSize, int MyYSlices, int ZBound_Low, ViewI CellType, ViewI LayerID, int id,
                  int layernumber, int np, int nx, int ny, int nz, int MyYOffset, ViewI GrainID, ViewF GrainUnitVector,
