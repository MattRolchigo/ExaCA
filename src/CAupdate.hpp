                ...
                for (int l = 0; l < 26; l++) {
                    ...
                    if (neighbor_index != -1) {
                        ...
                        if ((diagonal_length_cell >= interface.crit_diagonal_length(26 * index + l)) &&
                            ...
                            interface.cc_steering_vector(Kokkos::atomic_fetch_add(&interface.num_steer_cc(0), 1)) =
                                index;
                            l = 26;
                        }
                    }
                ...
                if (neighbor_index != -1) {
                    ...
                    if ((diagonal_length_cell >= interface.crit_diagonal_length(26 * index + l)) &&
                        ...
                        if (old_cell_type_value == Liquid) {
                            ...
                            const float crit_diagonal_length_capture = interface.crit_diagonal_length(26 * index + l);
                            ...
                            if (np > 1) {
                                ...
                                bool data_fits_in_buffer = interface.loadGhostNodes(
                                    ...
                                    ghost_octahedron_center_z, ghost_diagonal_length, grid.ny_local, neighbor_coord_x,
                                    neighbor_coord_y, neighbor_coord_z, grid.at_north_boundary, grid.at_south_boundary,
