...
void RunProgram_Reduced(int id, int np, std::string InputFile) {
    ...
    ViewS SpawnDirection(Kokkos::ViewAllocateWithoutInitializing("SpawnDirection"), DomainSize);
    ViewF GrainCenterLocation(Kokkos::ViewAllocateWithoutInitializing("GrainCenterLocation"), 3 * DomainSize);
    ViewF FractMaxTipVelocity(Kokkos::ViewAllocateWithoutInitializing("FractMaxTipVelocity"), DomainSize);
    ...
    for (int layernumber = 0; layernumber < NumberOfLayers; layernumber++) {
        ...
        do {
            ...
            CellCapture(id, np, cycle, nx, ny_local, irf, y_offset, NeighborX, NeighborY, NeighborZ, GrainUnitVector,
                        ...
                        numSteer, numSteer_Host, AtNorthBoundary, AtSouthBoundary, BufSize, SpawnDirection, GrainCenterLocation, FractMaxTipVelocity);
            ...
            if (OldBufSize != BufSize) {
                ...
                RefillBuffers(nx, nz_layer, ny_local, cellData, BufferNorthSend, BufferSouthSend, SendSizeNorth,
                              ...
                              NGrainOrientations, BufSize, SpawnDirection, GrainCenterLocation, FractMaxTipVelocity);
            }
            ...
            if (np > 1) {
                ...
                GhostNodes1D(cycle, id, NeighborRank_North, NeighborRank_South, nx, ny_local, y_offset, NeighborX,
                             ...
                             BufferSouthRecv, BufSize, SendSizeNorth, SendSizeSouth, BufComponents, SpawnDirection, GrainCenterLocation, FractMaxTipVelocity);
